...
I've started to develop a favorite ice cream recipe that I adapted from [Key Lime Ice Cream](http://allrecipes.com/recipe/key-lime-ice-cream/). In my limited experience in ice cream, I've found that some recipes will produce an icy tasting ice cream, but this recipe keeps the ice cream smooth and creamy.
