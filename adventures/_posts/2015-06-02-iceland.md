...
{% include img.html src="2015-06-02-iceland-1.jpg" class="img-tall" alt="Reykjavík" width="2448" height="3264" %}
{% include img.html src="2015-06-02-iceland-2.jpg" alt="Reykjavík" width="3264" height="2448" %}
...
{% include img.html src="2015-06-02-iceland-3.jpg" alt="Untitled" class="img-half" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-4.jpg" alt="Sauðárkrókur" width="9204" height="2482" %}
{% include img.html src="2015-06-02-iceland-5.jpg" alt="Sauðárkrókur" width="3264" height="2448" %}
</div>
...
{% include img.html src="2015-06-02-iceland-6.jpg" class="img-tall" alt="Untitled" width="2353" height="3137" %}
{% include img.html src="2015-06-02-iceland-7.jpg" alt="Siglufjörður" width="3264" height="2448" %}
</div>

On our last day in Siglufjörður, we had lunch at Kaffi Rauðka

<div class="photos">
{% include img.html src="2015-06-02-iceland-8.jpg"  alt="Around Sigló" width="3107" height="2330" %}
</div>

and visited the museums.

<div class="photos">
{% include img.html src="2015-06-02-iceland-9.jpg" alt="Around Sigló" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-10.jpg"  alt="Around Sigló" class="img-half" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-11.jpg"  alt="Around Sigló" class="img-half" width="3264" height="2448" %}
</div>
...
{% include img.html src="2015-06-02-iceland-0.jpg"  alt="Akureyri" class="img-tall" width="2448" height="3264" %}
</div>

And here's the waterfall of the gods, Goðafoss.

<div class="photos">
{% include img.html src="2015-06-02-iceland-12.jpg"  alt="Goðafoss" width="3264" height="2448" %}
</div>
...
{% include img.html src="2015-06-02-iceland-13.jpg"  alt="Heading south" class="img-half" width="3264" height="2448" %}
</div>
...
{% include img.html src="2015-06-02-iceland-14.jpg" alt="Uthlid cottage" class="img-half" width="3264" height="2448" %}
</div>

While in the area we visited Geysir

<div class="photos">
{% include img.html src="2015-06-02-iceland-15.jpg" alt="Geysir" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-16.jpg" class="img-half" alt="Geysir" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-17.jpg" class="img-half" alt="Geysir" width="3264" height="2448" %}
...
<div class="photos">
{% include img.html src="2015-06-02-iceland-18.jpg" alt="Gullfoss" width="3264" height="2448" %}
</div>
...
{% include img.html src="2015-06-02-iceland-19.jpg"  alt="Vatnsleyfoss" class="img-half" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-20.jpg"  alt="Vatnsleyfoss" width="3264" height="2448" %}
</div>

And then Kerið, a volcanic crater.

<div class="photos">
{% include img.html src="2015-06-02-iceland-21.jpg" alt="Kerið" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-22.jpg" alt="Kerið" width="7452" height="2450" %}
</div>

Then we visited two more waterfalls that were amazing and surprisingly vacant. Here's Þorsteinslundur.

<div class="photos">
{% include img.html src="2015-06-02-iceland-23.jpg"  alt="Þorsteinslundar" width="3264" height="2448" %}
...
<div class="photos">
{% include img.html src="2015-06-02-iceland-24.jpg" alt="Gluggafoss" class="img-tall" width="2448" height="3264" %}
{% include img.html src="2015-06-02-iceland-25.jpg" alt="Gluggafoss" class="img-wide" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-26.jpg" alt="Gluggafoss" width="10788" height="2392" %}
...
{% include img.html src="2015-06-02-iceland-27.jpg" alt="Vik" class="img-half" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-28.jpg" alt="Vík" width="3264" height="2448" %}
</div>

We walked on Reynisfjara beach.

<div class="photos">
{% include img.html src="2015-06-02-iceland-29.jpg"  alt="Reynisfjara Beach" width="2582" height="1936" %}
{% include img.html src="2015-06-02-iceland-30.jpg" alt="Reynisfjara Beach" class="img-tall" width="2448" height="3264" %}
{% include img.html src="2015-06-02-iceland-31.jpg" alt="Reynisfjara Beach" class="img-wide" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-32.jpg" alt="Reynisfjara Beach" width="3264" height="2448" %}
</div>

And then the cliffs at Dyrhólaey.

<div class="photos">
{% include img.html src="2015-06-02-iceland-33.jpg"  alt="Dyrhólaey" width="3264" height="2448" %}
</div>

We climbed the steep steps to see eye-to-eye with Skógafoss.

<div class="photos">
{% include img.html src="2015-06-02-iceland-34.jpg"  alt="Skógafoss" class="img-wide" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-35.jpg" alt="Skógafoss" class="img-tall" width="2448" height="3264" %}
...
<div class="photos">
{% include img.html src="2015-06-02-iceland-36.jpg"  alt="rock houses" width="3264" height="2448" %}
</div>
...
<div class="photos">
{% include img.html src="2015-06-02-iceland-37.jpg"  alt="Seljalandsfoss" class="img-wide" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-38.jpg" alt="Seljalandsfoss" class="img-tall" width="2448" height="3264" %}
{% include img.html src="2015-06-02-iceland-39.jpg" alt="Seljalandsfoss" width="7620" height="2396" %}
</div>
...
{% include img.html src="2015-06-02-iceland-40.jpg" alt="Eldfell" class="img-half" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-41.jpg" class="img-wide" alt="Eldfell" width="3264" height="2448" %}
{% include img.html src="2015-06-02-iceland-42.jpg" class="img-tall" alt="Eldfell" width="2448" height="3264" %}
{% include img.html src="2015-06-02-iceland-43.jpg" alt="Eldfell" width="9166" height="2332" %}
{% include img.html src="2015-06-02-iceland-44.jpg" alt="Around Heimaey" class="img-half" width="2582" height="1936" %}
{% include img.html src="2015-06-02-iceland-45.jpg" alt="Around Heimaey" class="img-half" width="3264" height="2448" %}
</div>
...
{% include img.html src="2015-06-02-iceland-46.jpg" class="img-tall" alt="Blue Lagoon" width="2448" height="3264" %}
