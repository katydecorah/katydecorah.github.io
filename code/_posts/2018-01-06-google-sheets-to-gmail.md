...
<p class="note">
{% include icons/zap.svg %} Try the updated version of this post where I'll teach you <a href="/code/google-sheets-to-gmail-template/">how to draft your email in Google docs</a>.
</p>
