...
I built [read action](https://github.com/katydecorah/read-action), a [GitHub Action](https://github.com/features/actions), that tracks the books that you've read by writing the book metadata to a yaml file. Services, like Goodreads, already exist, but I want to own my data.
